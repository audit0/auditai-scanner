...
-- plus a private Storage bucket for per-user documents. Policies are correct; the bug is in the app.
...
-- A signed-in user reaches only their own folder. The vulnerable app downloads through the service
-- role and therefore never meets these policies.
