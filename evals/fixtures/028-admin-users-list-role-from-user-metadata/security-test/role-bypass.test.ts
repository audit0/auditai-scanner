/** Fixture 028: a member who edits their own user_metadata must still be refused the user list. */
...
describe("admin users gate", () => {
  it("self-promoted member is still denied: DENY", async () => {
